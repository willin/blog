    ...
    <div className='dropdown dropdown-end'>
      ...
      <div
        ...
        <ul className='menu menu-compact gap-1 p-3'>
          ...
          <li>
            <a href='https://sso.willin.wang/dashboard/me' className='block' target='_blank' rel='noreferrer'>
              {t('common.profile')}
            </a>
          </li>
          <li>
            <Form method='post' action='/auth/logout' className='block'>
              <button className='block w-full text-left' type='submit' onClick={confirmLogout}>
                {t('common.logout')}
              </button>
            </Form>
          </li>
