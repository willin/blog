...
const social: SocialItem[] = [
  ...
  // 知乎
  {
    ...
    icon: 'https://img.shields.io/badge/dynamic/json?label=Zhihu&query=$.data.totalSubs&url=https%3a%2f%2fapi.spencerwoo.com%2fsubstats%2f%3fsource%3dzhihu%26queryKey%3dwillin&color=0084ff&logo=Zhihu&longCache=true'
  },
  // 微博
  {
    name: '微博',
    url: 'https://weibo.com/willinx',
    icon: 'https://img.shields.io/badge/dynamic/json?label=weibo&query=$.data.totalSubs&url=https%3a%2f%2fapi.spencerwoo.com%2fsubstats%2f%3fsource%3dweibo%26queryKey%3d1860509070&color=ffa339&logo=sina-weibo&longCache=true'
  },
  // 网易云音乐
  {
    name: '网易云音乐',
